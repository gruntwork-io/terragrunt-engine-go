...
source = ["./examples/client-server/client/bin/terragrunt-iac-engine-client_darwin_arm64", "examples/client-server/server/bin/terragrunt-iac-engine-server_darwin_arm64"]
...
zip {
  output_path = "terragrunt-iac-engine-client-server_arm64.zip"
}
